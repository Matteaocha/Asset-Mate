...
var tasks = require(path.dirname(__filename) + '/lib/gulp-tasks.js')
var fs = require('fs')
...
gulpfileHeader += "var amTasks		= require('./node_modules/asset-mate/lib/gulp-tasks.js')\n"
gulpfileHeader += "var amCopy 		= require('./node_modules/asset-mate/lib/copy.js')\n"
gulpfileHeader += "var amRewrite 	= require('./node_modules/asset-mate/lib/rewrite.js')\n"
gulpfileHeader += "var amAWS 		= require('./node_modules/asset-mate/lib/aws.js')\n"
gulpfileHeader += "var amImages		= require('./node_modules/asset-mate/lib/images.js')\n"
gulpfileHeader += "var amGulpfile	= require('./node_modules/asset-mate/gulpfile.js')\n"
gulpfileHeader += "\n"
gulpfileHeader += "\n"
gulpfileHeader += "//----------------------------------------------------------------\n"
gulpfileHeader += "\n"
gulpfileHeader += "var action 	= amGulpfile.determineAction(manifest)\n"
